...
export const Icons = {
    ...
    smInfo: `<svg width="16" height="16" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" fill="#C0C0C0" stroke="#000" stroke-width="1"/><text x="8" y="11" fill="#000080" font-family="serif" font-size="9" font-weight="bold" text-anchor="middle">i</text></svg>`,
    ...
    // Paint tool icons
    toolBrush: `<svg width="16" height="16" viewBox="0 0 16 16"><rect x="8" y="2" width="6" height="4" rx="2" fill="#FFF" stroke="#000" stroke-width="1"/><line x1="8" y1="5" x2="5" y2="9" stroke="#000" stroke-width="1.2"/><path d="M5,9 C3,10 2,12 3,14 C5,13 7,11 6,9 Z" fill="#222"/></svg>`,
    toolPencil: `<svg width="16" height="16" viewBox="0 0 16 16"><path d="M2 14 L10 6 L13 3 L14 4 L6 12 Z" fill="#FFE080" stroke="#000" stroke-width="1"/><line x1="1" y1="15" x2="5" y2="11" stroke="#000" stroke-width="1.5"/></svg>`,
    toolEraser: `<svg width="16" height="16" viewBox="0 0 16 16"><rect x="2" y="8" width="12" height="6" rx="1" fill="#FFF" stroke="#000" stroke-width="1"/><rect x="4" y="5" width="8" height="4" rx="0.5" fill="#FFB0B0" stroke="#000" stroke-width="1"/></svg>`,
    toolFill: `<svg width="16" height="16" viewBox="0 0 16 16"><rect x="3" y="3" width="7" height="8" rx="1" fill="#A0A0A0" stroke="#000" stroke-width="1" transform="rotate(-15 6.5 7)"/><path d="M9,5 L13,2 L14,3 L10,6 Z" fill="#000"/><circle cx="12" cy="11" r="2" fill="#0000FF"/></svg>`,
    toolLine: `<svg width="16" height="16" viewBox="0 0 16 16"><line x1="2" y1="14" x2="14" y2="2" stroke="#000" stroke-width="2" stroke-linecap="round"/><circle cx="2" cy="14" r="1.5" fill="#000"/><circle cx="14" cy="2" r="1.5" fill="#000"/></svg>`,
    toolRect: `<svg width="16" height="16" viewBox="0 0 16 16"><rect x="3" y="4" width="10" height="9" rx="1" fill="none" stroke="#000" stroke-width="1.5"/></svg>`,
    toolCircle: `<svg width="16" height="16" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" fill="none" stroke="#000" stroke-width="1.5"/></svg>`,
    toolText: `<svg width="16" height="16" viewBox="0 0 16 16"><text x="2" y="13" font-family="serif" font-size="11" font-weight="bold" fill="#000">Tt</text></svg>`,
    toolPicker: `<svg width="16" height="16" viewBox="0 0 16 16"><path d="M2 14 L7 9 L9 11 L14 2" fill="none" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><circle cx="14" cy="2" r="2" fill="#00F"/></svg>`,
    ...
    secGraduation: `<svg width="16" height="16" viewBox="0 0 16 16"><polygon points="8,1 15,6 15,14 1,14 1,6" fill="none" stroke="#000" stroke-width="1.5"/><polygon points="8,1 8,8 15,6" fill="#C0C0C0" stroke="#000" stroke-width="1"/><line x1="5" y1="10" x2="11" y2="10" stroke="#000" stroke-width="1"/><line x1="5" y1="12" x2="11" y2="12" stroke="#000" stroke-width="1"/></svg>`,
    ...
    cpWallpaper: `<svg width="16" height="16" viewBox="0 0 16 16"><rect x="1" y="1" width="14" height="14" fill="#008080" stroke="#000" stroke-width="1"/><circle cx="5" cy="5" r="2" fill="#FFF" opacity="0.5"/><circle cx="11" cy="4" r="2.5" fill="#FFF" opacity="0.5"/></svg>`,
